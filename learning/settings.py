...
class LearningSettings:
    ...
    media_reply_chance: float = field(default_factory=lambda: _float("MEDIA_REPLY_CHANCE", 0.10))
    ...
    media_meme_chance: float = field(default_factory=lambda: _float("MEDIA_MEME_CHANCE", 0.22))
    media_cooldown: int = field(default_factory=lambda: _int("MEDIA_COOLDOWN", 900))
    meme_render_cooldown: int = field(default_factory=lambda: _int("MEME_RENDER_COOLDOWN", 3600))
    media_template_cooldown: int = field(default_factory=lambda: _int("MEDIA_TEMPLATE_COOLDOWN", 7200))
